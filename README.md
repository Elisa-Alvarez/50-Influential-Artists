...
1. How would you describe preprocessing to someone new to CSS?
  ...
  It allows you to group related styles together without needing to identify indevidual elements.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

   That I can nest the child element within the parent while styling. The part that gives me the most trouble is using the compiler on small projects it doesn't seem effective

3. How would you explain the concept of a variable to someone new to programming?

A varible is a placeholder that we assign a value to it.

4. What is the purpose of using functions in code?
 
  It allows the computer to process multiple problems and call on the information later
